...
def region_map(request):
    ...
    select_aquifer = SelectInput(display_text='Select Aquifer',
                                 ...
                                 options=[('', 9999), ('Carrizo', 10), ('Edwards', 11), ('Edwards-Trinity', 13), ('Gulf Coast', 15), ('Hueco Bolson', 1), ('Ogallala', 21),
                                          ('Pecos Valley', 3), ('Seymour', 4), ('Trinity', 28), ('Blaine',
                                                                                                 6), ('Blossom', 7), ('Bone Spring-Victorio Peak', 8),
                                          ('Brazos River Alluvium', 5), ('Capitan Reef Complex',
                                                                         9), ('Dockum', 26), ('Edwards-Trinity-High Plains', 12),
                                          ('Ellenburger-San Saba', 14), ('Hickory',
                                                                         16), ('Igneous', 17), ('Lipan', 30), ('Marathon', 18),
                                          ('Marble Falls', 19), ('Nacatoch', 20), ('Queen City',
                                                                                   24), ('Rita Blanca', 23), ('Rustler', 25),
                                          ('Sparta', 27), ('West Texas Bolsons', 2), ('Woodbine', 29), ('Yegua Jackson', 31), ('Texas', -999)],
                                 initial='',
                                 attributes={
                                     # this calls list_dates, which then calls change_aquifer
                                     'onchange': 'list_dates(2)'
                                 }
                                 )
    ...
    select_view = SelectInput(display_text='Select Data Type',
                              name='select_view',
                              multiple=False,
                              options=[("Depth to Groundwater", 'depth'), ('Elevation of Groundwater',
                                                                           'elevation'), ("Well Drawdown", "drawdown")],
                              attributes={
                                  'onchange': 'changeWMS()'
                              }
                              )
