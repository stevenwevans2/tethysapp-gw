function add_aquifer_settings(){
    ...
    $.ajax({
        ...
        type: 'GET',
        data: {'region':region,'AquiferID':AquiferID,'DisplayName':DisplayName,'Aquifer_Name':Aquifer_Name,'HydroID':HydroID,'AqID':AqID,'Elev':Elev,'Type':Type,'Depth':Depth,'porosity':porosity},
